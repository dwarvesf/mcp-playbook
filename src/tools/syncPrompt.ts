...
export const SyncPromptArgsSchema = z.object({
  ...
  description: z
    .string()
    .describe("A brief description of the prompt's purpose."),
  model: z
    .string()
    .describe("The model used for the prompt (e.g., openai/gpt-4o-mini)."),
  modelParameters: z
    .record(z.any())
    .describe("Parameters for the model, such as temperature and maxTokens."),
  messages: z
    .array(
      z.object({
        role: z
          .string()
          .describe("The role of the message sender (e.g., system, user)."),
  ...
  testData: z
    ...
    .optional()
    .describe("An array of test cases for the prompt."),
  evaluators: z
    .array(
      z.object({
    ...
    .optional()
    .describe("An array of evaluators for the prompt."),
});
